    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.div 
          ...
          className="w-24 h-px bg-gradient-to-r from-transparent via-[#c5a572] to-transparent mx-auto mb-10"
        />
        ...
        >
          <button
            ...
            className="inline-flex mt-[200px] items-center gap-2 rounded-full border border-[#c5a572] bg-stone-900/80 px-6 py-3 text-sm md:text-base font-medium text-stone-50 shadow-lg hover:bg-[#c5a572] hover:text-stone-900 hover:shadow-xl transition-all duration-300"
          >
