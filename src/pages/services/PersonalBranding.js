          ...
          >
            ...
            <div className="space-y-5">
              {[
                ...
                "YouTube/Podcast guest strategy with long-form to short-form content repurposing.",
          ...
          >
            <div className="bg-stone-50/80 backdrop-blur-sm rounded-3xl p-10 shadow-2xl">
              ...
              <ul className="text-stone-700 space-y-2 text-lg">
                <li>• 10x LinkedIn impressions and profile visits.</li>
                <li>• 5x increase in qualified website traffic.</li>
                <li>• A premium client pipeline built on inbound trust.</li>
              </ul>
            </div>
            ...
            <div className="bg-stone-50/80 backdrop-blur-sm rounded-3xl p-10 shadow-2xl">
              ...
              <p className="text-stone-700 text-lg font-light leading-relaxed mb-3">
                The intent is to make your name shorthand for a specific outcome in your market—clear positioning,
                consistent narrative, and platforms that reinforce each other instead of competing for attention.
              </p>
              <p className="text-stone-700 text-lg font-light leading-relaxed">
                Strategy, content, and design are aligned so that visibility turns into recognition, and recognition into demand.
              </p>
            </div>
          </motion.div>
        </section>
